...
prices_day_1 = pd.read_csv("round-3-island-data-bottle/prices_round_3_day_0.csv", sep=';')
prices_day_1 = pd.DataFrame(prices_day_1)
prices_day_2 = pd.read_csv("round-3-island-data-bottle/prices_round_3_day_1.csv", sep=';')
prices_day_2 = pd.DataFrame(prices_day_2)
prices_day_2.timestamp = prices_day_2.timestamp + 1000000
prices_day_3 = pd.read_csv("round-3-island-data-bottle/prices_round_3_day_2.csv", sep=';')
...
prod1 = data[data['product'] == 'DJEMBES'][['timestamp', 'mid_price']].rename(columns={'mid_price': 'djembes'})
prod2 = data[data['product'] == 'JAMS'][['timestamp', 'mid_price']].rename(columns={'mid_price': 'croissants'})

# Merge on timestamp
merged = pd.merge(prod1, prod2, on='timestamp', how='inner')
